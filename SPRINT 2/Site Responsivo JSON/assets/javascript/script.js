...
function carregarPagina(apiUrl) {
  fetch(apiUrl)
    ...
    .then(data => {
      // Extrair e manipular dados conforme necessário
      ...
      instagramImg.src = "assets/img/instagram.png"; // Coloque o caminho correto para a imagem do Instagram
      ...
      twitterImg.src = "assets/img/twitter.png"; // Coloque o caminho correto para a imagem do Twitter
      ...
      facebookImg.src = "assets/img/facebook.png"; // Coloque o caminho correto para a imagem do Facebook
